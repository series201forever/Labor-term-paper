...
if dmt == 1 && dft == 1 && nt > 0
term=(Beta+Beta^2+Beta^3+Beta^4+Beta^5+Beta^6+Beta^7+Beta^8+Beta^9+Beta^10)*...
...
term=(Beta+Beta^2+Beta^3+Beta^4+Beta^5+Beta^6+Beta^7+Beta^8+Beta^9+Beta^10)*(((max(wm + wf + y - conskid*nt,0)).^(1 - ucurve)) / (1 - ucurve) + ...
          vfir .* nt - vsec .* nt^2);
elseif dmt == 1 && dft == 0
term=(Beta+Beta^2+Beta^3+Beta^4+Beta^5+Beta^6+Beta^7+Beta^8+Beta^9+Beta^10)*(((max(wm + y - conskid*nt,0)).^(1 - ucurve)) / (1 - ucurve) + ...
          vfir .* nt - vsec .* nt^2);
elseif dmt == 0 && dft == 1
term=(Beta+Beta^2+Beta^3+Beta^4+Beta^5+Beta^6+Beta^7+Beta^8+Beta^9+Beta^10)*(((max(wf + y - conskid*nt,0)).^(1 - ucurve)) / (1 - ucurve) + ...
          vfir .* nt - vsec .* nt^2);
else     
term=(Beta+Beta^2+Beta^3+Beta^4+Beta^5+Beta^6+Beta^7+Beta^8+Beta^9+Beta^10)*(((max(y - conskid*nt,0)).^(1 - ucurve)) / (1 - ucurve) + ...
          vfir .* nt - vsec .* nt^2);
end
